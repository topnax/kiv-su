...
function plotThetaJ (X, y, optimal_theta, costFunction)
	...
	theta0_vals = linspace(optimal_theta(1) - 50000, optimal_theta(1) + 50000, 100);
	theta1_vals = linspace(optimal_theta(2) - 50000, optimal_theta(2) + 50000, 100);
	theta2_vals = linspace(optimal_theta(3) - 50000, optimal_theta(3) + 50000, 100);
